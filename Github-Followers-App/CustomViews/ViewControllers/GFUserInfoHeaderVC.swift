...
class GFUserInfoHeaderVC: UIViewController {
    ...
    func configureUIelements() {
        avatarImageView.downloadImageFromUrl(from: user.avatarUrl)
        ...
        locationImageView.image     = UIImage(systemName: SFSysmbols.location)
    ...
    func layoutUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            nameLabel.leadingAnchor.constraint(equalTo: avatarImageView.leadingAnchor, constant: padding),
